...
const Form = ({ setCreate, setUsers }) => {
    ...
    return (
        <div>
            <div>
                ...
                <form onSubmit={handleCreateUser} className='w-[180px] md:w-[250px]  absolute top-[80px] right-[40px] flex flex-col gap-5 bg-gradient-to-r from-green-600 to-neutral-800  ' >
                    <h1 className='text-[20px] font-bold'>Form</h1>
                    <input type="text" placeholder="Your name" className='bg-transparent border border-black rounded-[20px] text-center outline-none m-2 p-2' value={inputs.name} onChange={(e) => setInputs({ ...inputs, name: e.target.value })} />
    ...
    ">
                    ...
                    <div className="flex justify-between m-2">
                        ...
                        <button className='text-white bg-gradient-to-r from-green-700 to-teal-700 rounded-[10px] p-2 w-[40px] text-[10px] m-2' >Add</button>
